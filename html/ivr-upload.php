...
$path = "/var/lib/asterisk/sounds/ivr/$accountcode-menu.wav";
...
unlink ("/var/lib/asterisk/sounds/ivr/$accountcode-menu.mp3");

$db -> query ( "delete from ivr_audio where accountcode='$accountcode'");
$db -> query ( "insert into ivr_audio values ( null, '$accountcode', '$accountcode-menu', '00:00:00', '23:59:59')");
