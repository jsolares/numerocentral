...
/*
    ...
    File used for webcall
	You need to change the URL it sends the call request to in strSend.
*/
...
<input type="Hidden" name="ivr" value="<?php echo $ivr; ?>">
<table>        <tr><td><a href="https://www.numerocentral.com"><img src="https://www.numerocentral.com/pics/nclogo.png"></td></tr><tr><td>Mi N&uacute;mero Telef&oacute;nico: </td></tr><tr><td><input type="Text" name="phonenumber" value=""></td></tr>
